        ...
        <header className={headerStyles.header}>
            <nav>
                <ul className={headerStyles.navList}>
                    ...
                    <li>
                        <a className={headerStyles.navItem} activeClassName={headerStyles.activeNavItem} href="https://guide.nannou.cc" aria-label="Guide" target="_blank" rel="noopener noreferrer">
                            GUIDE
                        </a>
                    </li>
                    <li>
